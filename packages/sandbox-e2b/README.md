...
把一个已创建好的 [E2B](https://e2b.dev)（真实 Firecracker microVM）沙盒包成 `NimboFS & NimboExec`，一次注入 `createSession(agent, { workspace })`——"模式 A 同源工作区"落在真实云沙盒上的实现（对照 [docs/core/core-sdk/tech.md §4.5a](../../docs/core/core-sdk/tech.md) / [docs/host/sandbox/tech.md §8](../../docs/host/sandbox/tech.md)）。
...
## 已知限制（docs/host/sandbox/tech.md §8.2 / docs/core/core-sdk/plan.md P10-1 实际改动，如实照抄不发明）
