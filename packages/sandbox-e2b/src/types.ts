/**
 * `e2b` SDK 面的最小结构化子集（docs/logic/engine/tech/core-sdk.md §4.5a 施工依据 docs/host/contract/tech/sandbox.md §8.1
...
export interface E2bSandboxLike {
   ...
   * 在这里语义相反，见 docs/logic/orchestration/tech/sandbox-keepalive.md §1）。
   *
