 ...
 * （docs/logic/engine/tech/core-sdk.md §4.1；`BuiltinToolName` 联合与 `READ_ONLY_TOOLS` 见
 * docs/logic/engine/tech/builtin-tools.md §3）。
 */
...
/**
 * 内置工具名联合（docs/logic/engine/tech/builtin-tools.md §3）：九个默认全开、可经
...
/** 只读审查场景一行开箱的预设组合（docs/logic/engine/tech/builtin-tools.md §3），纯类型层面的常量、非新机制。 */
...
/** agent 定义：纯声明，无运行状态（docs/logic/engine/tech/core-sdk.md §4.1）。 */
