/**
 * Skills 注入三件事（docs/logic/engine/tech/core-sdk.md §4.6）：① `<available_skills>` system prompt 段
...
/** skill 附属文件挂载目录的约定前缀（docs/logic/engine/tech/builtin-tools.md §1.9 / docs/logic/engine/tech/core-sdk.md §4.6 第 3 点）。 */
...
/**
 * `<available_skills>` 段：每 skill 一行 `name: description`（docs/logic/engine/tech/core-sdk.md §4.6
...
/**
 * `ctx.getSkill` 的真实现（docs/logic/engine/tech/core-sdk.md §4.6 第 2 点 + §4.1 `ToolContext.getSkill`）：
...
/**
 * 附属文件挂载（docs/logic/engine/tech/core-sdk.md §4.6 第 3 点）：把每个 skill 的 `files` 经
