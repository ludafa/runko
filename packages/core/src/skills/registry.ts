/**
 * Skills 注入三件事（tech-spec §4.6）：① `<available_skills>` system prompt 段
...
/** skill 附属文件挂载目录的约定前缀（04-builtin-tools.md §1.9 / tech-spec §4.6 第 3 点）。 */
...
/**
 * `<available_skills>` 段：每 skill 一行 `name: description`（tech-spec §4.6
...
/**
 * `ctx.getSkill` 的真实现（tech-spec §4.6 第 2 点 + §4.1 `ToolContext.getSkill`）：
...
/**
 * 附属文件挂载（tech-spec §4.6 第 3 点）：把每个 skill 的 `files` 经
