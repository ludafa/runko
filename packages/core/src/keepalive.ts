 ...
 * （docs/logic/orchestration/tech/sandbox-keepalive.md §5.4）。
 *
 ...
 * 沙盒就会在跑到一半时被平台暂停。详见 docs/logic/orchestration/features/sandbox-keepalive.md §1。
 *
 * ---- 三个信号源，一个闸门 ----
 *
...
/** 一次真实续期尝试的结果，交给宿主看日志、以及同步宿主自己的存活时间账（见 docs/logic/orchestration/tech/sandbox-keepalive.md §6.1）。 */
