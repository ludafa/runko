 ...
 * 存一份模型视图（docs/logic/orchestration/tech/single-ledger.md §0 TL;DR）。
 *
...
// ============================================================================
// RunkoMessageMetadata（docs/logic/orchestration/tech/single-ledger.md §5-2 目标架构 1）：
...
// ============================================================================
// RunkoDataParts（docs/logic/orchestration/tech/single-ledger.md §5-2 目标架构 1 / §2.2b，deny 分支已转用 ai 原生审批
// 状态机，`data-approval` 因此作废——见 docs/logic/orchestration/tech/single-ledger.md §5 引言"§2.2b 相应条目作废"）：
// 五个 data 部件，类型名即 `data-file-change` 等。`tool-progress` 是
// transient——只在写入期经 `emitTransientDataPart`（loop.ts）分流出流，绝不
// 进 `UIMessage.parts`（docs/logic/orchestration/tech/single-ledger.md §4.1 发现 A：transient 是线协议 chunk 上的
...
// ============================================================================
// RunkoUIMessage / RunkoChunk（docs/logic/orchestration/tech/single-ledger.md §5-2 目标架构 1/2）
// ============================================================================
...
/**
 * 恢复校验的深层通路（docs/logic/orchestration/tech/single-ledger.md §5-2 目标架构 1"恢复校验：用 ai@7 的
