 ...
 * （docs/logic/engine/tech/core-sdk.md §4.1/§4.2/§4.4/§4.5a/§4.8），P1-2 追加 L1 定义层
 * defineAgent/defineTool/defineSkill（docs/logic/engine/tech/core-sdk.md §4.1）。P4-1 追加审批链 +
 * ToolRuntime + update-plan；P4-2 追加 L2 运行层 `createSession`/`runTurn`
 * （docs/logic/engine/tech/core-sdk.md §4.2 全节），P4 收尾。P5 追加 skills：`Skill.fromDirectory/
 ...
 * （docs/host/contract/tech/sandbox.md §4）追加 `RunkoFS.searchFiles?`/`searchContent?` 与配套
