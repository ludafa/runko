...
const OUTPUT_BYTE_LIMIT = 64 * 1024; // docs/tech/builtin-tools.md §1.10：stdout/stderr 各自 64KB 上限
...
/** stdout/stderr 合并文本 + 退出码（docs/tech/builtin-tools.md §1.10 输出规格）。 */
 ...
 * "review"（旧 "always"）、沙盒实现通常 "allow"（旧 "never"），docs/tech/single-ledger.md §6.1
