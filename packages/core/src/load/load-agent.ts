/**
 * `loadAgent(dir, opts?)`：L3 目录约定层（docs/logic/engine/tech/core-sdk.md §4.7；P7-3 工单任务 2）——
...
/** docs/logic/orchestration/tech/single-ledger.md §6.1 三值重构：固定策略字符串是 "allow"/"review"/"review-once"/"deny"（旧 "never"/"always"/"once" 已废）。 */
...
/**
 * L3 目录约定层（docs/logic/engine/tech/core-sdk.md §4.7）：把一个 eve 布局的 agent 目录加载成
