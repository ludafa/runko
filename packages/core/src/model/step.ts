/**
 * L0 模型层：单步 `streamText` 封装 `runStep`（docs/core/core-sdk/tech.md §4.3 全节 / §4.8）。
 *
 ...
 * `fullStream` 换成非弃用名 `stream`，行为不变，见 docs/core/core-sdk/tech.md §4.3"措辞校准"。）
 *
...
/** `runStep` 结束后的汇总（docs/core/core-sdk/tech.md §4.3 第 3 点）。 */
