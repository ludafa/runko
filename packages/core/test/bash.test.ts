...
describe("createBashTool", () => {
  ...
  describe("approval default (§1.10 取 exec.defaultApproval; docs/logic/orchestration/tech/single-ledger.md §6.1 三值重构 never→allow / always→review)", () => {
  ...
  describe("execute(): timeout/non-zero exit are normal results, not thrown errors (§1.10 / docs/logic/engine/tech/builtin-tools.md §4)", () => {
  ...
  describe("onOutput → ctx.update() (§1.10 / docs/logic/engine/tech/builtin-tools.md §4)", () => {
