...
describe("defineTool", () => {
  ...
  describe("approval (docs/logic/orchestration/tech/single-ledger.md §6.1 三值重构)", () => {
    ...
    it("rejects the retired 'never'/'always'/'once' literals at the type level (2026-07-15 三值重构, docs/logic/orchestration/tech/single-ledger.md §6.1)", () => {
