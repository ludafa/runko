/**
 * STEER-1/STEER-1F (`Session.steer`, docs/logic/engine/tech/core-sdk.md §4.2) acceptance tests — see the
 ...
 *
 * P13-5-2（docs/logic/orchestration/tech/single-ledger.md）迁移：`session.stream()`/
 ...
 *
 * STEER-1F (docs/logic/engine/tech/core-sdk.md §4.2, "STEER-1F 修复" / "已知缺口"): fixed the tool-calls
...
// ---------------------------------------------------------------------------
// STEER-1F regression #2: the declared known gap. docs/logic/engine/tech/core-sdk.md §4.2 states that
// `runOneStep`/`executeStepToolCalls` throwing (`aborted`/`provider_error`)
...
describe("runTurn — known gap (docs/logic/engine/tech/core-sdk.md §4.2): provider_error does not drain queued steer messages", () => {
...
// ---------------------------------------------------------------------------
// STEER-3T (STEER-3A Finding 4, docs/logic/engine/tech/core-sdk.md §4.2): steer() must honestly return
...
// ---------------------------------------------------------------------------
// 7. steered input fidelity — docs/logic/orchestration/tech/single-ledger.md §5-2 裁量: the old `user_message.text`
