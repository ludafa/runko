...
/**
 * P13-5-2c (docs/logic/orchestration/tech/single-ledger.md §6.4) split the old atomic `executeToolCall`
...
describe("executeToolCall", () => {
  describe("does not validate input or evaluate approval — that is resolveToolCallApproval's job (P13-5-2c split, docs/logic/orchestration/tech/single-ledger.md §6.4)", () => {
