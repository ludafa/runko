/**
 * `localExec` (P7-3 task 1, docs/logic/engine/tech/core-sdk.md §4.5a / docs/logic/engine/tech/builtin-tools.md §1.10).
...
describe("localExec()", () => {
  describe("defaultApproval (docs/logic/engine/tech/builtin-tools.md §1.10 出厂值; docs/logic/orchestration/tech/single-ledger.md §6.1 三值重构 always→review)", () => {
  ...
  describe("describe() (docs/logic/engine/tech/builtin-tools.md §1.10 环境自描述, ≤150 token 规格)", () => {
