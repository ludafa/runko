/**
 * `localExec` (P7-3 task 1, docs/core/core-sdk/tech.md §4.5a / docs/core/builtin-tools/tech.md §1.10).
...
describe("localExec()", () => {
  describe("defaultApproval (docs/core/builtin-tools/tech.md §1.10 出厂值; docs/agent/single-ledger/tech.md §6.1 三值重构 always→review)", () => {
  ...
  describe("describe() (docs/core/builtin-tools/tech.md §1.10 环境自描述, ≤150 token 规格)", () => {
