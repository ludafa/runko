...
describe("ApprovalOutcome (docs/logic/orchestration/tech/single-ledger.md §6.1 三值)", () => {
...
describe("ApprovalPolicy (docs/logic/orchestration/tech/single-ledger.md §6.1)", () => {
...
describe("HumanDecision (docs/logic/orchestration/tech/single-ledger.md §6.3 — two values only, updatedInput deleted)", () => {
  ...
  it("the allow branch's own declared shape has no updatedInput property (deleted 2026-07-15, docs/logic/orchestration/tech/single-ledger.md §6.3)", () => {
...
describe("RunkoFS / RunkoExec / Tool / ToolContext shapes", () => {
  ...
  it("accepts a RunkoFS implementation that also implements the optional searchFiles/searchContent seam (docs/host/contract/tech/sandbox.md §4)", async () => {
    const fs: RunkoFS = {
      readFile: async () => new Uint8Array(),
      writeFile: async () => {},
      rm: async () => {},
...
describe("FileSearchQuery / FileSearchResult (RunkoFS.searchFiles, docs/host/contract/tech/sandbox.md §4)", () => {
...
describe("ContentSearchQuery / ContentSearchResult (RunkoFS.searchContent, docs/host/contract/tech/sandbox.md §4)", () => {
