/**
 * RunkoExec 表面契约（docs/logic/engine/tech/core-sdk.md §4.5b "RunkoExec 表面" 一节）：describe() 的
...
describe("a genuinely broken injected RunkoFS still resolves instead of rejecting (§4.5a never-reject, defensive fallback)", () => {
