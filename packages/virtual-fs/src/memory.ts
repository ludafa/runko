/**
 * MemoryFS：纯内存路径树，实现 core 的 RunkoFS 全部七方法（docs/logic/engine/tech/core-sdk.md §4.4）。
 ...
 *
 * 命名说明（工单裁量）：docs/logic/engine/tech/core-sdk.md §4.4 写的是 `RunkoFS.fromMemory(...)`，但
