 ...
 *
 * P13-5-2（docs/logic/orchestration/tech/single-ledger.md）迁移：`drainStream` 改收集
 ...
 * 结算态（docs/logic/orchestration/tech/single-ledger.md §4.1 实现教训），因此按工具部件类型/data 部件类型 flatMap
