/**
 * `@nimbo/sdk` 的默认装配版 `createSession`（docs/core/core-sdk/tech.md §2 门面定位 / §4.2 L2 运行层
 * / docs/core/builtin-tools/tech.md §3 `builtinTools` 语义）。包装 `@nimbo/core` 的原始
...
/** 八件套的全部工具名，按 docs/core/builtin-tools/tech.md §1.1–§1.8 的声明顺序列出。 */
...
/**
 * `agent.builtinTools` 对文件工具八件套的过滤（docs/core/builtin-tools/tech.md §3）：
