/**
 * `@runko/sdk` 的默认装配版 `createSession`（docs/logic/engine/tech/core-sdk.md §2 门面定位 / §4.2 L2 运行层
 * / docs/logic/engine/tech/builtin-tools.md §3 `builtinTools` 语义）。包装 `@runko/core` 的原始
...
/** 八件套的全部工具名，按 docs/logic/engine/tech/builtin-tools.md §1.1–§1.8 的声明顺序列出。 */
...
/**
 * `agent.builtinTools` 对文件工具八件套的过滤（docs/logic/engine/tech/builtin-tools.md §3）：
