/**
 * `@runko/sandbox-vercel` 公共入口（docs/logic/engine/tech/core-sdk.md §4.5a "模式 A 同源工作区" / docs/06
 ...
 * 结构化接口 `VercelSandboxLike` 而非具体类（docs/host/contract/tech/sandbox.md §8.1）。
 */
