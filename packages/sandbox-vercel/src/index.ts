/**
 * `@nimbo/sandbox-vercel` 公共入口（docs/core/core-sdk/tech.md §4.5a "模式 A 同源工作区" / docs/06
 ...
 * 结构化接口 `VercelSandboxLike` 而非具体类（docs/host/sandbox/tech.md §8.1）。
 */
import type { NimboActivityAware, NimboExec, NimboFS, NimboKeepAliveCapable } from "@nimbo/core";
...
export type VercelWorkspace = NimboFS & NimboExec & NimboActivityAware & NimboKeepAliveCapable;
