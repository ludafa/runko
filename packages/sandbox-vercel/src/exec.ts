 ...
 * （docs/host/contract/tech/sandbox.md §3.2 / §8.2 Vercel 列）。
 *
 ...
 *
 * 工单研究文档（docs/host/contract/tech/sandbox.md §2/§8.2）说 Vercel "无 timeout 选项"，但实测当前安装的
...
export function createVercelExec(sandbox: VercelSandboxLike, root: string, keepAlive?: KeepAlive): RunkoExec {
  return {
    ...
    async exec(req: ExecRequest, execOpts?: ExecOptions): Promise<ExecResult> {
      ...
      /**
       * [保活](../../../docs/terms.md)的第二个信号源（docs/logic/orchestration/tech/sandbox-keepalive.md §3.1）：
