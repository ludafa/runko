/**
 * Vercel 的[保活](../../../docs/terms.md)接线（docs/logic/orchestration/tech/sandbox-keepalive.md §5.5）。
 *
 ...
 * （docs/logic/orchestration/tech/turn-checkpoint.md §5）。闸门的补足语义 + 这里的差额计算合起来修掉它。
 */
