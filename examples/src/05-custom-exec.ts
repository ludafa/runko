/**
 * 05-custom-exec — "bring your own sandbox" (docs/logic/engine/features/core-sdk.md §3.4 /
 * docs/logic/engine/tech/core-sdk.md §4.5a): `RunkoExec` is a three-method interface
 ...
 * the approval chain has to change (this is docs/logic/engine/features/core-sdk.md §6's fourth success
...
async function modelDrivenSection(): Promise<void> {
  ...
  // request; without a session-level arbiter it would be denied by design (docs/logic/engine/tech/core-sdk.md §4.5a
