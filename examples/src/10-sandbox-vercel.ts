 ...
 * for the shared background: docs/host/contract/tech/sandbox.md §8,
 * docs/logic/engine/plans/core-sdk.md P10). This one wraps a Vercel Sandbox — a real
 ...
 * @vercel/sandbox`).
 *
 * Same structural-interface story as 09 (docs/host/contract/tech/sandbox.md §8.1): `vercelWorkspace(sandbox,
 ...
 *      get backfilled into docs/misc/plans/verification.md once a user supplies the three variables.
 */
...
async function realSandboxSection(): Promise<void> {
  ...
  // persistent default (docs/host/contract/tech/sandbox.md §3.3).
