 ...
 * for the shared background: docs/host/sandbox/tech.md §8,
 * docs/core/core-sdk/plan.md P10). This one wraps a Vercel Sandbox — a real
 ...
 * @vercel/sandbox`).
 *
 * Same structural-interface story as 09 (docs/host/sandbox/tech.md §8.1): `vercelWorkspace(sandbox,
 ...
 *      get backfilled into docs/core/verification/plan.md once a user supplies the three variables.
 */
...
async function realSandboxSection(): Promise<void> {
  ...
  // persistent default (docs/host/sandbox/tech.md §3.3).
