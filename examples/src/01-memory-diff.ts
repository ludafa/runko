 ...
 * docs/logic/engine/features/core-sdk.md §3.1: a code snippet lives only in memory, the
...
async function deterministicSection(): Promise<void> {
  ...
  // MemoryFS has no persistent base snapshot (docs/logic/engine/tech/core-sdk.md §4.4) — every entry
