 ...
 * 需要自部署一个 HTTP 网关把两边接起来（docs/host/contract/tech/sandbox.md §6）。角色 ② 就是那个
 ...
 *
 * 明确不在范围内（见 docs/host/cloudflare/plans/cloudflare-worker-server.md）：
 ...
 * docs/host/cloudflare/plans/cloudflare-worker-server.md「发现的缺陷」。
 *
