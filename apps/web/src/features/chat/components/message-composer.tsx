 ...
 * 只是多了一个「去哪」的选择（docs/logic/orchestration/features/steer-and-queue.md §2）：
 *
 ...
 * docs/logic/orchestration/tech/turn-abort.md §4.2）：点它停止这一轮。所以流式期间那颗按钮**不再**是排队
...
export function MessageComposer({
   ...
   * （docs/ingress/features/composer-skill-mention.md）。缺省空数组：清单没到（或这个会话
    ...
    >
      <PromptInputBody>
        {/*
          ...
          （docs/ingress/tech/composer-skill-mention.md §2.4）——换引擎只为拿到 skill 提及
