/**
 * 本轮统计按钮 + 弹窗（docs/ingress/features/telemetry.md · docs/ingress/tech/telemetry.md §4.2）：
 ...
 *   输出，docs/ingress/tech/telemetry.md §2.4——回答「发完消息盯着空白等的那几秒花在
...
/**
 * 起轮装配打点（docs/ingress/tech/telemetry.md §2.4，`apps/node-server` 的
...
/**
 * 「本轮准备」小节的行（docs/ingress/features/telemetry.md）：把「发完消息盯着空白等的那
