 ...
 *
 * ai-elements 出厂密度是给「一屏几条消息」的通用聊天场景设的。nimbo chat 一轮
...
export const MessageContent = ({
  ...
  <div
    className={cn(
      ...
      // sm 档：assistant 侧撑满栏宽——它装的是工具卡片/审批/计划这类块级内容，
      // w-fit 会让每张卡片宽度各不相同，像一堆没对齐的碎片。
      'group-[.is-assistant]:w-full',
      'group-[.is-user]:bg-secondary group-[.is-user]:text-foreground group-[.is-user]:ml-auto group-[.is-user]:rounded-lg group-[.is-user]:px-3 group-[.is-user]:py-2',
