/**
 * `schemas/chat.ts`'s wire vocabulary (docs/logic/orchestration/tech/single-ledger.md §5
...
describe('schemas/chat: chunkEnvelopeSchema', () => {
  it('parses an envelope with no `seq` key at all — the ephemeral shape (docs/logic/orchestration/tech/single-ledger.md §5 单-3)', () => {
