...
describe('sandbox-manager', () => {
  ...
  it('acquire(): reports which of the three paths it took via `mode` (观测字段，docs/ingress/tech/telemetry.md §2.4)', async () => {
  ...
  // -------------------------------------------------------------------------
  // SP-7 缓存失效 + 保活心跳（docs/host/contract/tech/sandbox-provider.md §5.1）。
