/**
 * Pure-function coverage for `agent/approval-policy.ts` (docs/ingress/tech/chat-webapp.md
 * §2.2c（审批链）, docs/logic/orchestration/tech/single-ledger.md §6 三值重构):
...
describe('agent/approval-policy: classifyApproval', () => {
  ...
  describe('never returns "deny" (docs/logic/orchestration/tech/single-ledger.md §6.2 — chat always routes an escalation to a human)', () => {
