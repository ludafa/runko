 ...
 * (docs/logic/orchestration/tech/single-ledger.md §5 单-3, P13-5-3/P13-5-5): small
 ...
 * `@runko/core`'s loop actually produces, docs/logic/orchestration/tech/single-ledger.md §2.2b) but is a parameter
