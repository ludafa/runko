...
export interface FakeSandboxManager extends SandboxManager {
   ...
   * on a specific acquire (docs/host/contract/tech/sandbox-provider.md §3.1), so
  ...
  /** 覆盖 `acquire()` 报出的 `mode`（缺省 `'resume'`）——用来断言 `turn-launcher` 把它原样写进 `turn-prepare` 载荷（docs/ingress/tech/telemetry.md §2.4）。 */
   ...
   * 见 docs/logic/orchestration/tech/turn-abort.md §3.3。
   *
