/**
 * 推送通知的共享类型（docs/ingress/tech/push-notification.md §6.1）。
 *
 ...
 * 原样显示、不做任何判断。理由见 docs/ingress/tech/push-notification.md 附录 B.1——那份
...
export interface PushPayload {
  ...
  /** 已按 docs/ingress/tech/push-notification.md §6.1 截断。 */
  title: string;
  /** 同上。 */
  body: string;
   ...
   *
   * **按类型分档，不是全局开关**（docs/ingress/tech/push-notification.md §6.4）：要审批、
  ...
  callId?: string;
  /**
   * 通知上的操作按钮（docs/ingress/tech/push-notification.md §6.5）。省略 = 没有按钮，
   * 点通知只跳转。
   *
