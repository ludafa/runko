/**
 * 投递层（docs/ingress/tech/push-notification.md §6）：给定一个 userId 和一条载荷，投给
 ...
 * 通知发不出去，绝不能让一轮跑不下去（docs/ingress/tech/push-notification.md §9 不变量 1）。
 */
...
export interface SendOptions {
   ...
   * （docs/ingress/tech/push-notification.md §6.3）。
   */
  ttlSeconds?: number;
  logger?: Logger;
 ...
 *
 * 失败处置分两档（docs/ingress/tech/push-notification.md §6.5）：
 *
