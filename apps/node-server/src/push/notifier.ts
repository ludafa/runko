/**
 * 通知决策层（docs/ingress/tech/push-notification.md §5、§6.1）——四个[通知触发点](../../../../docs/terms.md)
...
/**
 * 哪几类[挂住不消失](../../../../docs/terms.md)（docs/ingress/tech/push-notification.md §6.4）。
 *
...
/**
 * 审批通知上的按钮（docs/ingress/tech/push-notification.md §6.5）。
 *
