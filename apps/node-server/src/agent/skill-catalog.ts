 ...
 * [skill 提及](../../../../docs/terms.md)的文本解析——docs/ingress/tech/composer-skill-mention.md
 * §5.1。
 *
...
/**
 * 扫描并加载沙盒里全部 skill（docs/ingress/tech/composer-skill-mention.md §1 改动 A）。
 *
...
/**
 * 从消息文本里扫出被提及的 skill 名（docs/ingress/tech/composer-skill-mention.md §5.1）。
 *
...
/**
 * 拼出发给模型的文本（docs/ingress/tech/composer-skill-mention.md §2.2）。
 *
 * **提及为空时原样返回同一个字符串**——不用这个功能的用户，喂给模型的字节与
 * 本功能上线前完全一致，零副作用。
 *
 * 这一行提示是「[软提示](../../../../docs/ingress/features/composer-skill-mention.md)」
