/**
 * chat 的 telemetry 落库（docs/ingress/tech/chat-webapp.md §11.4）：ai@7 转正的
 ...
 * docs/logic/orchestration/tech/single-ledger.md §3.2），按同一对 (agent_session_id, turn) 即可 join。
 */
...
export function createTelemetryStore(path: string): TelemetryStore {
  ...
  // 耗材式 schema 演化（docs/ingress/tech/telemetry.md §3）：检测到更名前的旧列
