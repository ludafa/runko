...
> 相关文档：[账本设计](./single-ledger.md)（本文要改的就是它 §2.4／§6 描述的做法）· [chat 服务端](./chat-webapp.md) §2.2b（一轮怎么跑、断线怎么重连）· [产品视角](../features/chat-webapp.md) · [施工进展](../plans/in-flight-draft.md)
...
| 9 | 回头修订[账本设计](./single-ledger.md) §2.4／§6，产品文档补一句行为变化 | 文档 |
