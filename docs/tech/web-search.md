...
> 相关：[产品文档](../features/web-search.md) · [施工进展](../plans/web-search.md) · [chat 应用技术方案 §4/§6](./chat-webapp.md) · [内置工具技术方案](./builtin-tools.md) · 术语见 [docs/terms.md](../terms.md)
...
所以它落在 chat 应用侧，形态与 `ask-user` 完全同构（[chat-webapp §6](./chat-webapp.md)）：
