...
> 相关：产品/使用视角见 [../features/graceful-shutdown.md](../features/graceful-shutdown.md)，技术方案见 [../tech/graceful-shutdown.md](../tech/graceful-shutdown.md)。
> 依赖/延续：[停止本轮](../features/turn-abort.md)（本功能整个建在 `abortTurn` 上）· [chat webapp §5.1](../tech/chat-webapp.md)（[轮状态快照](../terms.md)，界面层的第三道防线，已完成）。
