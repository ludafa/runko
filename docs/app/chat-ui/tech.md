...
> 相关：[产品文档](./feature.md) · [施工进展](./plan.md) · [chat 应用技术方案](../chat-webapp/tech.md)
...
- **遥测是可关闭、可清空的耗材**（docs/app/telemetry/tech.md），聚合它意味着「关了遥测，会话统计就空了」——而「这个会话花了多少」属于产品数据，不该随可选的观测设施一起消失。
