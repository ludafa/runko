...
> 产品文档 [功能](../features/sandbox-keepalive.md)，技术方案 [技术方案](../tech/sandbox-keepalive.md)。
...
- `docs/logic/orchestration/features/sandbox-keepalive.md`、`docs/logic/orchestration/tech/sandbox-keepalive.md`、本文件。

- `docs/logic/orchestration/tech/turn-checkpoint.md` §5 顶部加了「本节已被取代」说明（写清推翻了什么、保留了什么）。
...
**结论回填**：跑完把实际结果写回本节，与 [verification · 施工进展](../../../misc/plans/verification.md) 的既有格式对齐。
