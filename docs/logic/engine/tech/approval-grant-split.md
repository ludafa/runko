...
related: ["logic/engine/features/approval-grant-split.md", "logic/engine/plans/approval-grant-split.md", "architecture/tech/agent-kernel.md"]
---
# 分段授权（技术方案）

> 相关：[产品视角](../features/approval-grant-split.md) · [施工进展](../plans/approval-grant-split.md)
> 依赖：[chat 应用技术方案 §6](../../../ingress/tech/chat-webapp.md)（[会话级授权](../../../terms.md)现状）
