...
> 依赖：[single-ledger](../single-ledger/plan.md)（P14 依赖 **P13-5** 落地——账本必须先是「UIMessage 单账本」）
> 回填目标（P14-4）：[core/core-sdk/plan](../../core/core-sdk/plan.md) 变更记录 · [core/verification/plan](../../core/verification/plan.md) 用例 · [app/chat-webapp/tech](../../app/chat-webapp/tech.md) 存储相关表述 · [terms.md](../../terms.md) §七
...
4. **P14-4 文档回填（主线程）**：core/core-sdk/plan 变更记录、core/verification/plan 用例、app/chat-webapp/tech 存储相关表述修订、terms.md §七校对。
...
设计层面的取舍与理由见 [技术方案 · 已知限制](./tech.md#已知限制)，施工时需照单落地的约束：
...
- **2026-07-15**：从旧编号文档 `docs/agent/compaction/tech.md` 迁入 features / tech / plans 三视角结构。原文「产品设计」入 [features](./feature.md)，「技术方案」（§2.1–2.7）入 [tech](./tech.md)，验证项（§2.8）与施工计划（§3）入本文。历史 banner「设计待 review（2026-07-15）」保留于本文顶部。
- **2026-07-15**：设计待 review。本方案兑现 [core/core-sdk/tech](../../core/core-sdk/tech.md) §4.8「自动 compaction 列 v2」的规划；依赖 P13-5（single-ledger）落地。
