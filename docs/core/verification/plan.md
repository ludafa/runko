...
> 依赖 [core-sdk](../core-sdk/feature.md)：本方案逐条映射 core-sdk 的四条成功标准（成功标准原文见 [docs/core/core-sdk/feature.md](../core-sdk/feature.md) §6；见 §2），并作为 [core-sdk 施工](../core-sdk/plan.md) 的验收闭环。
> 历史来源：docs/core/verification/plan.md（旧编号，收口阶段统一清理）。
...
> 相关文档（收口后新结构）：[core/core-sdk/feature](../core-sdk/feature.md)（§6 成功标准为本方案的验收基准）· [core/core-sdk/tech](../core-sdk/tech.md) · [core/core-sdk/plan](../core-sdk/plan.md) P8/P10 · [examples/README.md](../../../examples/README.md)
...
corepack pnpm build          # 必须先于 typecheck/test：跨包类型解析指向 dist（docs/core/core-sdk/plan.md P4-2 顺序结论）
...
## 2. 成功标准用例表（docs/core/core-sdk/feature.md §6 逐条映射，无遗漏）

§6 共四条成功标准，每条至少一个用例；用例 ID 前缀即标准序号。四条标准即 core-sdk 的验收基准（见开头“相关”行的 [core-sdk](../core-sdk/feature.md) 链接）。
...
任何改动合入前，仓库根目录按序全绿（顺序固定，理由见 §1.2 注释与 docs/core/core-sdk/plan.md P4-2）：
...
CI（`.github/workflows/`）跑 1–3 与 5（P8-2 起，examples typecheck 入 CI——docs/core/core-sdk/plan.md P8-1 裁定）；4 为本地门槛（阈值已在 vitest 配置强制）。
