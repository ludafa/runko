---
title: "Cloudflare Worker Server（施工进展）"
...
> 依赖：[sandbox 技术方案](../../contract/tech/sandbox.md)（§6 网关形态与协议、§7 workerd 实测）· [沙盒 provider 产品文档](../../contract/features/sandbox-provider.md) · [chat-webapp 技术方案](../../../ingress/tech/chat-webapp.md)
