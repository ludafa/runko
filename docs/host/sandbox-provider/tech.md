...
> 依赖：[chat-webapp 技术方案](../../app/chat-webapp/tech.md)（§2.2 `sandbox-manager.ts`、§4 服务端模块）· [sandbox 技术方案](../sandbox/tech.md)（§8 沙盒适配器契约）
...
**修法四层**（对应 `docs/host/sandbox-provider/plan.md` SP-7）：
